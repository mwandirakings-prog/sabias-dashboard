      ...
      <div style={{ display: 'grid',
        ...
        {[
          ...
          <div key={label} style={{ background: 'white', borderRadius: 12,
            ...
            <div style={{ color: '#3E1F00', fontSize: 17,
          ...
          <div style={{ display: 'flex', gap: 8, alignItems: 'center',
            ...
            <input type="number" placeholder="Set target (MWK)"
              ...
              style={{ padding: '8px 12px', borderRadius: 8,
                border: '1.5px solid #FFB800', fontSize: 13, width: 160 }}/>
            <button onClick={() => {
            ...
            <LineChart data={chartData}
              ...
              {forecast3.length > 0 && (
                <ReferenceLine x={forecast3[0]?.month}
                  ...
                  label={{ value: 'Forecast', fontSize: 9 }}/>
              )}
              ...
              {forecast6.map((f, i) => {
                ...
                return (
                  <tr key={i} style={{
                    ...
                    <td style={{ padding: '9px 12px', color: '#2D6A4F',
                                 fontWeight: '500' }}>MK {fmt(f.revenue)}</td>
                    <td style={{ padding: '9px 12px', color: '#FF6B35',
                                 fontWeight: '500' }}>MK {fmt(f.profit)}</td>
                    <td style={{ padding: '9px 12px' }}>{margin}%</td>
